...
public class VerCitasPaciente extends JFrame {
	...
	public VerCitasPaciente() {
		...
		JLabel lblVerCitasDe = new JLabel("Ver citas de un paciente");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					for(Cita ct :Main.hp.getCitasPaciente(textField.getText())) {
						bld.append(ct + "\n");
					}
